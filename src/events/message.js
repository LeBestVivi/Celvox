    ...
    if (command && !disabledCommands.includes(command.name)) {
      ...
      if (modChannelIds.includes(message.channel.id)) {
        if (
          ...
          return; // Return early so Celvox doesn't respond
        }
      }
      ...
      const embed = new MessageEmbed()
        .setTitle('Hi, I\'m Celvox. Need help?')
        ...
        .addField('Invite Me', oneLine`
          ...
          [here](https://discord.com/oauth2/authorize?client_id=533346993578311690&scope=bot&permissions=403008599)!
        `)
        .addField('Support', oneLine`
          If you have questions, suggestions, or found a bug, please join the 
          [Celvox Support Server](https://discord.com/invite/y4D3rd2)!
        `)
        .setFooter('DM Vivi#3834 to speak directly with the developer!')
