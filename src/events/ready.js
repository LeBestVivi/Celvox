module.exports = async (client) => {
  ...
  for (const guild of leftGuilds) {
    ...
    client.logger.info(`Celvox has left ${guild.guild_name}`);
  }

  client.logger.info('Celvox is now online');
  client.logger.info(`Celvox is running on ${client.guilds.cache.size} server(s)`);
};
