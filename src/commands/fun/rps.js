...
module.exports = class RockPaperScissorsCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      description: 'Play a game of rock–paper–scissors against Celvox!',
  ...
  run(message, args) {
    ...
    else if (botChoice > userChoice || botChoice === 0 && userChoice === 2) result = '**Celvox** wins!';
    else result = `**${message.member.displayName}** wins!`;
    const embed = new MessageEmbed()
      .setTitle(`${message.member.displayName} vs. Celvox`)
      .addField('Your Choice:', res[userChoice], true)
      .addField('Celvox\'s Choice', res[botChoice], true)
