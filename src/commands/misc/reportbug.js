...
module.exports = class ReportBugCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      description: oneLine`
        Sends a message to the Celvox Support Server's bug report channel.
  ...
  run(message, args) {
    ...
    const embed = new MessageEmbed()
      ...
      .setDescription(oneLine`
        ...
        Please join the [Celvox Support Server](https://discord.com/invite/y4D3rd2) to further discuss your issue.
        Additionally, feel free to submit an issue on [GitHub](https://top.gg/bot/533346993578311690/issues).
      `) 
