...
module.exports = class FeedbackCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      description: 'Sends a message to the Celvox Support Server\'s feedback channel.',
      type: client.types.MISC,
      examples: ['feedback We love Celvox!']
    });
  }
  run(message, args) {
    ...
    const embed = new MessageEmbed()
      ...
      .setDescription(oneLine`
        ...
        Please join the [Celvox Support Server](https://discord.com/invite/y4D3rd2) to further discuss your feedback.
      `) 
